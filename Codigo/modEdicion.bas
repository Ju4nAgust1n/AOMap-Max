...
'*************************************************
    ...
    ElseIf Button = vbLeftButton Then
        ...
        ElseIf frmMain.cInsertarTrans.value Then
            ...
            If (Map < 0) Then 'Or (Map > NumMaps) Then
        ...
        Else
            Call InsertarZonaSegura(tx, tY, 1)
        End If
        ElseIf frmMain.cQuitarTrigger.value Then  ' Quitar Trigger
        If frmMain.Check1.value = 0 Then
            Call InsertarTrigger(tx, tY, 0)
        Else
            Call InsertarZonaSegura(tx, tY, 0)
        End If
        End If
    End If
End Sub

Public Sub GetMapData(ByVal X As Integer, ByVal y As Integer)
With MapData(X, y)
    ' Posicion
...
Public Sub QuitarCapasMedias(ByVal X As Integer, ByVal y As Integer, Optional ByVal ConDeshacer As Boolean = True)
Dim i As Byte
...
Public Function QuitarEstaCapa(ByVal X As Integer, ByVal y As Integer, Optional ByVal ConDeshacer As Boolean = True) As Boolean
...
Public Sub InsertarGrh(ByVal X As Long, ByVal y As Long, ByVal MOSAICO As Boolean, ByVal AutoCompletar As Boolean, ByVal Bloq As Boolean, Optional ByVal ConDeshacer As Boolean = True)
...
Public Sub InsertarBloq(ByVal X As Integer, ByVal y As Integer, Optional ByVal ConDeshacer As Boolean = True)
...
Public Sub QuitarBloq(ByVal X As Integer, ByVal y As Integer, Optional ByVal ConDeshacer As Boolean = True)
...
Public Sub InsertarObjTranslado(ByVal X As Integer, ByVal y As Integer, Optional ByVal ConDeshacer As Boolean = True)
With MapData(X, y)
...
Public Sub InsertarUnionManual(ByVal X As Integer, ByVal y As Integer, ByVal TargetMap As Integer, Optional ByVal ConDeshacer As Boolean = True)
...
Public Sub InsertarTileExit(ByVal X As Integer, ByVal y As Integer, ByVal TargetX As Byte, ByVal TargetY As Byte, ByVal TargetMap As Integer, Optional ByVal ConDeshacer As Boolean = True)
With MapData(X, y).TileExit
    If ConDeshacer Then _
...
Public Sub QuitarTileExit(ByVal X As Integer, ByVal y As Integer, Optional ByVal ConDeshacer As Boolean)
With MapData(X, y).TileExit
    If ConDeshacer Then _
...
Public Sub InsertarNpc(ByVal X As Integer, ByVal y As Integer, ByVal NPCIndex As Integer, Optional ByVal ConDeshacer As Boolean = True)
Dim Body As Integer
Dim Head As Integer
...
Public Sub QuitarNpc(ByVal X As Integer, ByVal y As Integer, Optional ByVal ConDeshacer As Boolean = True)
With MapData(X, y)
    If .NPCIndex > 0 Then
        If ConDeshacer Then _
...
Public Sub InsertarObjeto(ByVal X As Integer, ByVal y As Integer, ByVal objindex As Integer, ByVal Amount As Integer, Optional ByVal ConDeshacer As Boolean = True)
With MapData(X, y)
    If objindex > 0 Then
...
Public Sub QuitarObjeto(ByVal X As Integer, ByVal y As Integer, Optional ByVal ConDeshacer As Boolean)
With MapData(X, y)
    If .OBJInfo.objindex <> 0 Then
        If ConDeshacer Then _
...
Public Sub InsertarTrigger(ByVal X As Integer, ByVal y As Integer, ByVal Trigger As Byte, Optional ByVal ConDeshacer As Boolean)
With MapData(X, y)
...
Public Sub InsertarZonaSegura(ByVal X As Integer, ByVal y As Integer, ByVal Zona As Byte)
With MapData(X, y)
    If .TypeZona <> Zona Then
