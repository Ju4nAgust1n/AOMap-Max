...
Call MsgBox("Andá a los triggers y clickea donde quieras poner zona segura")
...
Call MsgBox("Debes introducir valores númericos. Estos pueden tener un mínimo de 1 y un máximo de " & (YMinMapSize + XMinMapSize) / 2 & ".")
