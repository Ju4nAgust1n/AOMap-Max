...
Dim ScreenXOffset   As Long
Dim ScreenYOffset   As Long
Dim minXOffset  As Long
Dim minYOffset  As Long
Dim PixelOffsetXTemp As Long 'For centering grhs
Dim PixelOffsetYTemp As Long 'For centering grhs
    ...
    For y = screenminY To screenmaxY
        ...
        For X = screenminX To screenmaxX
            With MapData(X, y)
                ...
                If MapData(X, y).TypeZona > 0 And frmMain.Check1.Value > 0 Then
                    Call TextDrawer.AddText(PixelOffsetXTemp + TilePixelWidth \ 2, PixelOffsetYTemp + TilePixelHeight \ 2, vbGreen, str(.TypeZona), True)
                End If
