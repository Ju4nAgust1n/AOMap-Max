...
Public Borrado As Byte

Public Direccion As Byte
Public Unificar As Byte
...
'Map sizes in tiles
Public Const XMaxMapSize As Integer = 300
Public Const XMinMapSize As Byte = 1
Public Const YMaxMapSize As Integer = 300
...
Public Type MapBlock
    TypeZona As Integer ' 1 = zona segura
